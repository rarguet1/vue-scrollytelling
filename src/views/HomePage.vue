<template>
  <v-container fluid class="pa-0" style="height: 100vh; padding-top: 20px;">
    <!-- Main content -->
    <v-row class="fill-height" align="center" justify="center">
      <v-col cols="12" class="text-center px-5 py-3">
        <h1 class="white--text">Explore our car dataset!</h1>
      </v-col>
    </v-row>
...
.carAnimation {
  ...
  height: 300px;
  margin: auto;
  background: linear-gradient(#880E4F, #F9CBE4);
  border-radius:50%;
...
.colour {
  ...
  border-bottom: 60px solid #EDC0C0;
  top:5px;
  left:-12px;
}
