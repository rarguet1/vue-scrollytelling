...
const carsData = [
  { model: 'Nissan Altima', passengerVolume: 100.8, cats: 546 },
  { model: 'Ford Fusion', passengerVolume: 102.8, cats: 559 },
  { model: 'Ford F-150', passengerVolume: 132, cats: 734 },
  { model: 'Toyota Camry', passengerVolume: 100.4, cats: 544 },
  { model: 'Ford Escape', passengerVolume: 98.7, cats: 534 },
  { model: 'Ford Focus', passengerVolume: 90.7, cats: 486 },
  { model: 'Honda Accord', passengerVolume: 103.6, cats: 563 },
  { model: 'Chevrolet Impala', passengerVolume: 105, cats: 572 },
  { model: 'BMW 3 Series', passengerVolume: 96, cats: 518 },
  { model: 'Honda Civic', passengerVolume: 97.8, cats: 528 }
];
